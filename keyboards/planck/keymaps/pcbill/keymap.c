 ...
 * |------+-------+-------+---------+-----------+----+----+-----------+----------+--------+------------+------|
 * | Esc  |    GUI|    Alt|    Lower|Space/Raise|    Shift|Space/Raise|     Lower|PgUp/alt|  PgDn      | Ctrl |
 * `----------------------------------------------------------------------------------------------------------'
 */
[_DVORAK] = {
  ...
  {KC_ESC, KC_LGUI, KC_LALT,LOWER, LT(4,KC_SPC),KC_LSFT,KC_LSFT,LT(4,KC_SPC),LOWER, ALT_T(KC_PGUP),KC_PGDN, KC_RCTL}
},
 ...
 */
[_RAISE] = {
  {KC_DLR,  KC_UNDS, KC_BSLS, KC_HASH,    KC_AT,   KC_LCBR, KC_RCBR, KC_1,    KC_2,    KC_3, KC_PLUS, KC_DEL},
  {KC_PLUS, KC_MINS, KC_ASTR, KC_SLSH,    KC_EQL,  KC_LPRN, KC_RPRN, KC_4,    KC_5,    KC_6, KC_0,   KC_ENT},
  {KC_CIRC, KC_AMPR, KC_PIPE, KC_QUESTION,KC_EXLM, KC_LBRC, KC_RBRC, KC_7,    KC_8,    KC_9, KC_TILD,KC_RSFT},
 ...
 */
[_LOWER] = {
  {KC_TAB,  KC_F10,  KC_F1,   KC_F2,   KC_F3,  KC_MUTE,  BL_TOGG, KC_PGUP, KC_UP,  KC_PGDN,KC_CIRC,  KC_DEL},
  {KC_CAPS, KC_F11,  KC_F4,   KC_F5,   KC_F6,  KC_VOLU,  BL_INC,  KC_LEFT, KC_DOWN,KC_RGHT,KC_DLR,  KC_ENT },
